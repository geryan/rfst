...
```{r}
disturbance_variables$landis_vars[[1]][[1]]sdm_results$brt.fit[[1]]
```
...
lp(temporally_agg_dist_vars$harvest_ag[[1]][[1]], twocol = TRUE)
```
...
lp(temporally_agg_dist_vars$harvest_ag[[1]], twocol = TRUE)
```
...
lp(temporally_agg_dist_vars$pb_ag[[1]][[1]], twocol = TRUE)
```
