...
saveRDS(
  ...
  file = sprintf(
    "%s/14.00_grid_eg.Rds",
    "/data/gpfs/projects/punim0995/rfst/output/RData"
  )
)
...
st_write(
  ...
  dsn = sprintf(
    "%s/grid_eg.shp",
    "/data/gpfs/projects/punim0995/rfst/output/pa"
  ),
  delete_dsn = TRUE
)
...
save(
  ...
  #vba_dat_ch,
  vba_dat_eg,
  file = "output/RData/14.0_sp_occ_metapop_list_eg.RData"
)
