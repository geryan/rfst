bind.simulation.repetitions <- function(arglist){ # means of overcoming memory limitations to do large number of repetitions of simulation - takes list of simulation results objects from same landscape and number of timesteps and returns single combined results object
