get.landis.vars <- function(
  ...
  result <- foreach(j = 0:timesteps) %do% {
    ...
    biom_oge <- rst.op(input1 = stack(bioAge_eucacama,
                                      bioAge_eucacype,
                                      bioAge_eucadalr,
                                      bioAge_eucadeli,
                                      bioAge_eucadent,
                       ...
                       op = "writeonly",
                       proj_mask = proj_mask,
                       filename = sprintf("%s/%s/%s_biom_oge_%03d.grd",
                                          proj_path,
                                          out_path,
                                          scn_id,
                                          j),
    ...
    biom_oge_3h <- rst.op(input1 = stack(bioAge_eucacama,
                                         bioAge_eucacype,
                                         bioAge_eucadalr,
                                         bioAge_eucadeli,
                                         bioAge_eucadent,
                          ...
                          op = "writeonly",
                          proj_mask = proj_mask,
                          filename = sprintf("%s/%s/%s_biom_oge_3h_%03d.grd",
                                             proj_path,
                                             out_path,
                                             scn_id,
                                             j),
    ...
    biom_oge_1k <- rst.op(input1 = stack(bioAge_eucacama,
                                         bioAge_eucacype,
                                         bioAge_eucadalr,
                                         bioAge_eucadeli,
                                         bioAge_eucadent,
                          ...
                          op = "writeonly",
                          proj_mask = proj_mask,
                          filename = sprintf("%s/%s/%s_biom_oge_1k_%03d.grd",
                                             proj_path,
                                             out_path,
                                             scn_id,
                                             j),
