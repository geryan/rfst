...
if(yearid == "EG19"){
  initial_population <- brick("/data/gpfs/projects/punim1340/rfst_eg/output/ip/ip_eg_19_b.grd")
} else{
  initial_population <- brick("/data/gpfs/projects/punim1340/rfst_eg/output/ip/ip_eg_20_b.grd")
}
