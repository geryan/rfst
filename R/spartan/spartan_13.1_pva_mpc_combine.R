...
file_list <- list.files("/data/gpfs/projects/punim0995/rfst/output/spartan_RData/mpc_pva/")
...
mpc_results_pva_ch <- bind_rows(mpc_pva_list)



save(
  mpc_results_pva_ch,
  file = "/data/gpfs/projects/punim0995/rfst/output/RData/13.1_pva_mpc.RData"
)
