...
gg_fut_env_vars <- foreach (i = seq_len(timesteps)) %do% {
  biomass_tot <- ch_mask
  ...
  stack(PROP_BIO_TARG, PROP_BIO_REGN, PROP_OLD_200, PROP_OLD_150, DIST_ROADS)
}

gg_fut_env_vars <- lapply(gg_fut_env_vars, function (x) {
  names(x) <- c("PROP_BIO_TARG", "PROP_BIO_REGN", "PROP_OLD_200", "PROP_OLD_150", "DIST_ROADS")
  x})
