...
knitr::opts_knit$set(root.dir = "/home/casey/Research/Github/NESP_Greater_Glider")
```
...
gg_popN <- stack(replicate(ncol(gg_trans_mat), floor(gg_hab_suit[[1]]*3)))
#gg_popN <- stack(replicate(ncol(gg_trans_mat), floor(gg_hab_suit*200)))

gg_popN <- gg_popN*gg_stable_states

idx <- which(!is.na(gg_hab_suit[]) & gg_hab_suit[] < 0.95)
...
gg_pop_dynamics <- population_dynamics(change = growth(transition_matrix = gg_trans_mat,
                                                       ...
                                                       #transition_function = deterministic_transitions(transition_matrix = gg_trans_mat,
                                                       #raster_name =  "fires")
),
...
gg_results <- simulation(landscape = gg_landscape,
                         ...
                         habitat_dynamics = NULL, #fires and logging included in landis model
                         timesteps = 25,
                         replicates = 3)
# )
plot(gg_results)
