...
ip_brt_gg_1 <- predict(s1_v[[1]], brt_gg_1, type = "response", n.trees = brt_gg_1$gbm.call$best.trees, filename = "output/habitat_pred/s1_p_brt_gg-000.tif", overwrite = TRUE)
...
```{r initial pred brt_gg_4}
ip_brt_gg_4 <- predict(s1_v[[1]][[v_gg_4[2:5]]], brt_gg_4, type = "response", n.trees = brt_gg_4$gbm.call$best.trees, filename = "output/habitat_pred/s1_p_brt_gg-000.tif", overwrite = TRUE)
...
Pseudo-absence
```{r brt_gg_ps}
brt_gg_ps <- gbm.step(data = md_gg_ps, gbm.x = c(2:5, 7:12), gbm.y = 1, family = "bernoulli", tree.complexity = 5, learning.rate = 0.001, step.size = 1, bag.fraction = 0.75, prev.stratify = FALSE, verbose = TRUE, max.trees = 2000)
```
...
```{r initial pred brt_gg_ps}
ip_brt_gg_ps <- predict(s1_v_gg[[1]], brt_gg_ps, type = "response", n.trees = brt_gg$gbm.call$best.trees, filename = "output/habitat_pred/s1_p_brt_gg_ps-000.tif", overwrite = TRUE)
plot(ip_brt_gg)
```
