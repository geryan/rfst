...
```{r}
#save.image("output/landscap-occupancy.RData")
```

```{r}
load(file = "output/landscap-occupancy.RData")
```
...
```{r s4_ip_gg}
s4_ip_gg <- predict(s4_iv_gg, s4_mod_gg, type = "response", n.trees = s4_mod_gg$gbm.call$best.trees,  filename = "s/output/habitat_pred/4_fp_gg-000.tif")
...
s1_gg_results_1 <- simulation(landscape = s1_gg_landscape,
...
saveRDS(object = s1_gg_results_1, file = "output/pva_results/s1_gg_results_1.Rds")
```


```{r}
plot(s1_gg_results_1)
```

```{r}
plot(s1_gg_results_1[1], type = "raster", stages = 0, timesteps = c(1:5))
```
...
```{r}
plan(sequential, workers = 1)
s3_gg_results_1 <- simulation(landscape = s3_gg_landscape,
...
saveRDS(object = s3_gg_results_1, file = "output/pva_results/s3_gg_results_1.Rds")
```


```{r}
plot(s3_gg_results_1)
```

```{r}
plot(s3_gg_results_1[1], type = "raster", stages = 0, timesteps = c(1:5))
```
...
```{r}
plan(sequential, workers = 1)
s4_gg_results_1 <- simulation(landscape = S4_gg_landscape,
...
saveRDS(object = s4_gg_results_1, file = "output/pva_results/s4_gg_results_1.Rds")
```


```{r}
plot(s4_gg_results_1)
```

```{r}
plot(s4_gg_results_1[1], type = "raster", stages = 0, timesteps = c(1:5))
```


## Leadbeater's Possum
```{r}
lb_trans_mat <- matrix(c(0.00,0.00,2,
                         0.50,0.00,0.00,
                         0.00,0.8,0.8),
...
s1_lb_pop[[1]][sample(s1_lb_idx, 10000)] <- 1
s1_lb_pop[[2]][sample(s1_lb_idx, 10000)] <- 1
s1_lb_pop[[3]][sample(s1_lb_idx, 10000)] <- 1
...
```{r}
plan(sequential, workers = 1)
s1_lb_results_1 <- simulation(landscape = s1_lb_landscape,
...
saveRDS(object = s1_lb_results_1, file = "output/pva_results/s1_lb_results_1.Rds")
```


```{r}
plot(s1_lb_results_1)
```

```{r}
plot(s1_lb_results_1[1], type = "raster", stages = 0, timesteps = c(1:5))
```
...
s3_lb_pop[[1]][sample(s3_lb_idx, 10000)] <- 1
s3_lb_pop[[2]][sample(s3_lb_idx, 10000)] <- 1
s3_lb_pop[[3]][sample(s3_lb_idx, 10000)] <- 1
...
```{r}
plan(sequential, workers = 1)
s3_lb_results_1 <- simulation(landscape = s3_lb_landscape,
...
saveRDS(object = s3_lb_results_1, file = "output/pva_results/s3_lb_results_1.Rds")
```

```{r}
plot(s3_lb_results_1)
```

```{r}
plot(s3_lb_results_1[1], type = "raster", stages = 0, timesteps = c(1:5))
```
...
s4_lb_pop[[1]][sample(s4_lb_idx, 10000)] <- 1
s4_lb_pop[[2]][sample(s4_lb_idx, 10000)] <- 1
s4_lb_pop[[3]][sample(s4_lb_idx, 10000)] <- 1
...
```{r}
plan(sequential, workers = 1)
s4_lb_results_1 <- simulation(landscape = s4_lb_landscape,
...
saveRDS(object = s4_lb_results_1, file = "output/pva_results/s4_lb_results_1.Rds")
```


```{r}
plot(s4_lb_results_1)
```

```{r}
plot(s4_lb_results_1[1], type = "raster", stages = 0, timesteps = c(1:5))
```
