...
```{r}
pseudo_abs <- randomPoints(ch_mask, 1000) %>%
  as.data.frame %>%
  mutate(PA = 0) %>%
...
```{r brt_gg_1}
brt_gg_1 <- gbm.step(data = mv_gg_1, gbm.x = c(2:ncol(mv_gg_1)), gbm.y = 1, family = "bernoulli", tree.complexity = 4, learning.rate = 0.001, step.size = 1, bag.fraction = 0.5, prev.stratify = FALSE, verbose = TRUE, max.trees = 5000)
```
...
ip_brt_gg_1 <- raster::predict(s1_v[[1]], brt_gg_1, type = "response", n.trees = brt_gg_1$gbm.call$best.trees, filename = "output/habitat_pred/s1_p_brt_gg-000.tif", overwrite = TRUE)
...
```{r brt_gg_4}
brt_gg_4 <- gbm.step(data = mv_gg_4, gbm.x = c(2:ncol(mv_gg_4)), gbm.y = 1, family = "bernoulli", tree.complexity = 4, learning.rate = 0.001, step.size = 1, bag.fraction = 0.5, prev.stratify = FALSE, verbose = TRUE, max.trees = 5000)
```
...
ip_brt_gg_4 <- predict(s1_v[[1]], brt_gg_4, type = "response", n.trees = brt_gg_4$gbm.call$best.trees, filename = "output/habitat_pred/s1_p_brt_gg-000.tif", overwrite = TRUE)
...
```
```{r brt_gg_4_ps}
brt_gg_4_ps <- gbm.step(data = mv_gg_4_ps, gbm.x = c(2:ncol(mv_gg_4_ps)), gbm.y = 1, family = "bernoulli", tree.complexity = 4, learning.rate = 0.001, step.size = 1, bag.fraction = 0.5, prev.stratify = FALSE, verbose = TRUE, max.trees = 5000)
```
...
```{r initial pred brt_gg_4}
ip_brt_gg_4_ps <- predict(s1_v[[1]], brt_gg_4_ps, type = "response", n.trees = brt_gg_4$gbm.call$best.trees, filename = "output/habitat_pred/s1_p_brt_4_ps_gg-000.tif", overwrite = TRUE)
...
```{r brt_gg_4_old}
brt_gg_4_old <- gbm.step(data = mv_gg_4_old, gbm.x = c(2:ncol(mv_gg_4_old)), gbm.y = 1, family = "bernoulli", tree.complexity = 4, learning.rate = 0.001, step.size = 1, bag.fraction = 0.5, prev.stratify = FALSE, verbose = TRUE, max.trees = 5000)
```

```{r sumary brt_gg}
summary(brt_gg_4_old)
```

```{r}
gbm.plot(brt_gg_4_old)
```


```{r initial pred brt_gg_4}
ip_brt_gg_4_old <- predict(s1_v[[1]], brt_gg_4_old, type = "response", n.trees = brt_gg_4$gbm.call$best.trees, filename = "output/habitat_pred/s1_p_brt_4_old_gg-000.tif", overwrite = TRUE)

#writeRaster(s1_ip_gg, "output/habitat_pred/s1_ip_gg.tif", overwrite = TRUE)
#s1_ip_gg <- raster(x = "output/habitat_pred/s1_ip_gg.tif")

plot(ip_brt_gg_4_old)
```
