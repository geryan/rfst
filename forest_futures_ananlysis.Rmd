...
```{r}
tm_lb <- matrix(c(0.00, 0.53 * 0.75, 0.79 *0.75,
                 0.53,        0.00,       0.00,
                 0.00,        0.53,       0.79),
               nrow = 3,
               ncol = 3,
...
```{r}
sum(getValues(initpops$init_pop[[1]][[1]]),
    getValues(initpops$init_pop[[1]][[2]]),
    getValues(initpops$init_pop[[1]][[3]]),
    na.rm = TRUE)
```
