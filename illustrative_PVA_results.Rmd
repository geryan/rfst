...
For each of the three scenarios we have 10 LANDIS simulations, which each will result in different p
...
## Maximum age
Maximum age of any tree in 1 ha cell.
...
ggplot(pops, aes(x = scenario, y = emp)) +
  geom_boxplot() +
  geom_point(aes(colour = rep), position = position_dodge()) +
  facet_grid(species~., scales = "free")
