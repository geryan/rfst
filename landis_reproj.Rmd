...
writeRaster(x = l4_ma_a,   filename = paste0(dirpath, "/", "EG2019_400/Zones_EG.img"),     format = "HFA", datatype = "INT4S", overwrite = TRUE)
writeRaster(x = l4_st_a,   filename = paste0(dirpath, "/", "EG2019_400/Stands_EG.img"),    format = "HFA", datatype = "INT4S", overwrite = TRUE)
