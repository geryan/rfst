...
###  RAW
```{r}
p_mss_min_gyle <- ggplot(data = mpc_rs %>% filter(climate_model == "ACCESS1-0")) +
  geom_boxplot(
    aes(
      y = scn,
      x = mpc_min,
...
```{r}
p_mss_med_gyle <- ggplot(data = mpc_rs %>% filter(climate_model == "ACCESS1-0")) +
  geom_boxplot(
    aes(
      y = scn,
      x = mpc_median,
  ...
  scale_fill_viridis_d() +
  facet_grid(landscape~., scales = "free_x")
...
###  delta
```{r}
p_dmss_min_gyle <- ggplot(data = mpc_rs %>% filter(climate_model == "ACCESS1-0")) +
...
```{r}
p_dmss_med_gyle <- ggplot(data = mpc_rs %>% filter(climate_model == "ACCESS1-0")) +
  geom_vline(xintercept = 0 ) +
  geom_boxplot(
    aes(
      y = scn,
...
### delta proportional
```{r}
p_pmss_min_gyle <- ggplot(data = mpc_rs %>% filter(climate_model == "ACCESS1-0")) +
  geom_vline(xintercept = 0 ) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_pmss_med_gyle <- ggplot(data = mpc_rs %>% filter(climate_model == "ACCESS1-0")) +
  geom_vline(xintercept = 0 ) +
  geom_boxplot(
    aes(
      y = scn,
