...
```{r}
knitr::opts_chunk$set(fig.width=6, fig.height=6, echo = FALSE, message = FALSE)
```
...
### raw
```{r}
p_emp_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp,
...
```{r}
p_emp95_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_95,
...
```{r}
p_empmed_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_med,
...
```{r}
p_med_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = med_pop,
...
```{r}
p_pex_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = prop_extant,
...
```{r}
p_tex_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = mean_tt_ex,
...
```{r}
p_demp_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_demp95_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dempmed_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dmed_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dpex_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dtex_gyle <- ggplot(pva_r_ch_45 %>% filter(sp == "gyle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_emp_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp,
...
```{r}
p_emp95_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_95,
...
```{r}
p_empmed_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_med,
...
```{r}
p_med_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_boxplot(
    aes(
      y = scn,
      x = med_pop,
...
```{r}
p_pex_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_boxplot(
    aes(
      y = scn,
      x = prop_extant,
...
```{r}
p_tex_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_boxplot(
    aes(
      y = scn,
      x = mean_tt_ex,
...
```{r}
p_demp_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_demp95_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dempmed_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dmed_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dpex_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dtex_pevo <- ggplot(pva_r_ch_45 %>% filter(sp == "pevo")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_emp_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp,
...
```{r}
p_emp95_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_95,
...
```{r}
p_empmed_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_med,
...
```{r}
p_med_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_boxplot(
    aes(
      y = scn,
      x = med_pop,
...
```{r}
p_pex_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_boxplot(
    aes(
      y = scn,
      x = prop_extant,
...
```{r}
p_tex_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_boxplot(
    aes(
      y = scn,
      x = mean_tt_ex,
...
```{r}
p_demp_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_demp95_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dempmed_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dmed_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dpex_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dtex_peau <- ggplot(pva_r_ch_45 %>% filter(sp == "peau")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_emp_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp,
...
```{r}
p_emp95_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_95,
...
```{r}
p_empmed_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_med,
...
```{r}
p_med_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = med_pop,
...
```{r}
p_pex_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = prop_extant,
...
```{r}
p_tex_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_boxplot(
    aes(
      y = scn,
      x = mean_tt_ex,
...
```{r}
p_demp_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_demp95_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dempmed_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dmed_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dpex_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dtex_smle <- ggplot(pva_r_ch_45 %>% filter(sp == "smle")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_emp_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp,
...
```{r}
p_emp95_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_95,
...
```{r}
p_empmed_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_med,
...
```{r}
p_med_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_boxplot(
    aes(
      y = scn,
      x = med_pop,
...
```{r}
p_pex_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_boxplot(
    aes(
      y = scn,
      x = prop_extant,
...
```{r}
p_tex_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_boxplot(
    aes(
      y = scn,
      x = mean_tt_ex,
...
```{r}
p_demp_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_demp95_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dempmed_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dmed_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dpex_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dtex_tyte <- ggplot(pva_r_ch_45 %>% filter(sp == "tyte")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_emp_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp,
...
```{r}
p_emp95_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_95,
...
```{r}
p_empmed_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_med,
...
```{r}
p_med_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_boxplot(
    aes(
      y = scn,
      x = med_pop,
...
```{r}
p_pex_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_boxplot(
    aes(
      y = scn,
      x = prop_extant,
...
```{r}
p_tex_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_boxplot(
    aes(
      y = scn,
      x = mean_tt_ex,
...
```{r}
p_demp_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_demp95_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dempmed_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dmed_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dpex_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dtex_vava <- ggplot(pva_r_ch_45 %>% filter(sp == "vava")) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_emp95_all <- ggplot(pva_r_ch_45 ) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_95,
...
```{r}
p_empmed_all <- ggplot(pva_r_ch_45 ) +
  geom_boxplot(
    aes(
      y = scn,
      x = emp_med,
...
```{r}
p_demp95_all <- ggplot(pva_r_ch_45 ) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
...
```{r}
p_dempmed_all <- ggplot(pva_r_ch_45 ) +
  geom_vline(xintercept = 0) +
  geom_boxplot(
    aes(
      y = scn,
